    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <?php include('../../layout/head/report_menu.php'); ?>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <a class="goback" style="cursor: pointer;" onclick="location.href='../../head/report_advisor.html'">
                                < ย้อนกลับ</a>
                        </div>
                        <div class="col-12 mx-auto" style="color: black;">
                            <br>
                            <h5 style="font-weight: bold;">รายชื่อนักศึกษา <span style="color: rgb(0, 110, 22);">ไม่ตามแผน</span>
                                มีจำนวน 1 คน</h5>
                            <div class="card">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <form method="" action="./student_info.html">
