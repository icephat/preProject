                        ...
                        <div class="card shadow mb-4">
                            <div class="card-body ">
                                <div class="row" style="padding: 20px;">
                                    <div class="col-sm-6">
                                        <p style="font-weight: bold; font-size: 12px;">
                                            <span style="color: #949cdf;">&nbsp;&nbsp;&nbsp;<span
                                                    style="color:#949cdf; font-size:15px;">~</span>
                                                นิสิตแรกเข้า&nbsp;&nbsp;</span>

                                            <span style="color: #9b4444; ">
                                                &nbsp;&nbsp;&nbsp; <svg style="color: #9b4444;"
                                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    fill="currentColor" class="bi bi-circle-fill" viewBox="0 0 16 16">
                                                    <circle cx="8" cy="8" r="8" />
                                                </svg> นิสิตพ้นสภาพ</span>
                                            <span style="color: #4e89ae;">&nbsp;&nbsp;&nbsp; <svg
                                                    style="color: #4e89ae;" xmlns="http://www.w3.org/2000/svg"
                                                    width="16" height="16" fill="currentColor" class="bi bi-circle-fill"
                                                    viewBox="0 0 16 16">
                                                    <circle cx="8" cy="8" r="8" />
                                                </svg> นิสิตกำลังศึกษา</span>
