...
$deptStudents = getStudentListStudyByDepartmentId($teacher["departmentId"]);
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <?php include('../layout/head/nisit_dep.php'); ?>
                <hr>
                <div class="row">
                    <div class="col-12 mx-auto">
                        <h4 style="color: green;">รายชื่อนิสิตในภาควิชา คณะวิศวกรรมศาสตร์ กำแพงแสน</h4>
                        <div class="card">
