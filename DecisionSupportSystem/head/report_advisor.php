                                                ...
                                                <div style="color: rgb(0, 9, 188);">
                                                    <div class="text-center">
                                                        <a style="color: rgb(0, 9, 188);"
                                                            href="../report_head/grade_advisor/honor.php">
                                                            <h4>เกียรตินิยม</h4>
                                                        </a>
                                                    </div>
                                                    <div class="text-center">
                                                ...
                                                <div style="color: rgb(0, 110, 22);">
                                                    <div class="text-center">
                                                        <a style="color: rgb(0, 110, 22);"
                                                            href="../report_head/grade_advisor/normal.php">
                                                            <h4>ปกติ</h4>
                                                        </a>
                                                    </div>
                                                    <div class="text-center">
                                                ...
                                                <div style="color: #ff8c00;">
                                                    <div class="text-center">
                                                        <a style="color: #ff8c00;"
                                                            href="../report_head/grade_advisor/prohigh.php">
                                                            <h4>รอพินิจ</h4>
                                                        </a>
                                                    </div>
                                                    <div class="text-center">
                                                ...
                                                <div style="color: rgb(255, 0, 0);">
                                                    <div class="text-center">
                                                        <a style="color: rgb(255, 0, 0);"
                                                            href="../report_head/grade_advisor/prodown.php">
                                                            <h4>โปรต่ำ</h4>
                                                        </a>
                                                    </div>
                                                    <div class="text-center">
                                        ...
                                        <tr style="border: 1px solid black; border-collapse: collapse;">
                                            <th style="border: 1px solid black; border-collapse: collapse; width: 50%;">
                                                ...
                                                <div style="color: rgb(0, 9, 188);">
                                                    <div class="text-center">
                                                        <a style="color: rgb(0, 9, 188);"
                                                            href="../report_head/status_advisor/plan.php">
                                                            <h4>ตามแผน</h4>
                                                        </a>
                                                    </div>
                                                    <div class="text-center">
                                            ...
                                            <th style="border: 1px solid black; border-collapse: collapse; ">
                                                <div style="color: rgb(0, 110, 22);">
                                                    <div class="text-center">
                                                        <a style="color: rgb(0, 110, 22);"
                                                            href="../report_head/status_advisor/noplan.php">
                                                            <h4>ไม่ตามแผน</h4>
                                                        </a>
                                                    </div>
                                                    <div class="text-center">
                                        ...
                                        <tr>
                                            <th style="border: 1px solid black; border-collapse: collapse;">
                                                ...
                                                <div style="color: #ff8c00;">
                                                    <div class="text-center">
                                                        <a style="color: #ff8c00;"
                                                            href="../report_head/status_advisor/retry.php">
                                                            <h4>พ้นสภาพ</h4>
                                                        </a>
                                                    </div>
                                                    <div class="text-center">
                                            ...
                                            <th style="border: 1px solid black; border-collapse: collapse;">
                                                <div style="color: rgb(255, 0, 0);">
                                                    <div class="text-center">
                                                        <a style="color: rgb(255, 0, 0);"
                                                            href="../report_head/status_advisor/finish.php">
                                                            <h4>จบการศึกษา</h4>
                                                        </a>
                                                    </div>
                                                    <div class="text-center">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <th scope='row' style=" text-align: left;  ">
                                                                ทุกท่าน</th>
                                                            <td style="font-weight: bold; text-align: right;">5 คน</td>
                                                            <td style='font-weight: bold; text-align: right;'>13 คน</td>
                                                            <td style='font-weight: bold; text-align: right;'>2 คน</td>
