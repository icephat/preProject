        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="row" style="color: black;">
                    ...
                    $generetions = getGeneretionInCourseByCouseName($courseName);
                    $countStudentInCourse = getCountStudentInCourseByCouseName($courseName);

                    ?>
                    <h5>หลักสูตร
                        <?php echo $courseName?> ณ ปี <?php echo $semesterYear?>
                        <!-- <?php
                                ...
                                <table class="table "
                                    ...
                                    <tr style="border: 1px solid black; border-collapse: collapse; ">
                                        <th class="t1" style="border: 1px solid black; border-collapse: collapse; width: 50%; ">
                                            ...
                                            <?php
                                            $countRangeGrade = getCountStudentGradeRangeByCourseNameAndSemesterYear($courseName, $semesterYear)
                            ...
                            <div class="col-sm-5 mx-auto">
                                <table class="table "
                                    ...
                                    <tr  style="border: 1px solid black; border-collapse: collapse;">
                                        <th class="t1" style="border: 1px solid black; border-collapse: collapse; width: 50%;">
                                            <?php
                                            $countPlanStatus = getCountStudentPlanStatusByCourseNameAndSemesterYear($courseName, $semesterYear)
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            ...
                            $countStudentGraduateRangeGradeSortByGeneretions = getCountStudentGradeRangeSortByGeneretionByCourseNameAndSemesterYearAndStudyYearAndStatus($courseName, $semesterYear, "จบการศึกษา");
                            $endgen=[];
                            $BEG=[];
                            $GEG=[];
                            $OEG=[];
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card shadow mb-4">
                            ...
                            $studentStatusGeneretions = getCountStudentStatusSortByGeneretionByCourseNameAndSemesterYearAndStudyYear($courseName, $semesterYear);
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped" cellspacing="0" style="color: black;">
                                                <thead style=" ">
                                                    <tr>
                                                        <th style=" text-align: right; ">รุ่น</th>
                                                        <th style="text-align: right; "><span>ตามหลักสูตร</span>
                                                        </th>
                                                        <th style="text-align: right; "><span>ไม่ตามหลักสูตร</span></th>
                                                        <th style="text-align: right; ">พ้นสภาพ</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                    ...
                    var myChart = new Chart(ctx, {
                        ...
                        data: {
                            ...
                            },
                            {
                                ...
                                data: studys,
                                backgroundColor: 'rgb(171,231,248)',
                                borderColor: [
                                    'rgba(150,186,169, 1)', //1
                                    'rgba(108,158,134, 1)',
                                    'rgba(66,130,100, 1)',
