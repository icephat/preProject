...
$deptStudents = getStudentListGradByDepartmentId($teacher["departmentId"]);
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <?php include('../layout/head/nisit_dep_gra.php'); ?>
                <hr>
                <div class="row">
                    <div class="col-12 mx-auto">
                        <h4 style="color: green;">รายชื่อนิสิตในภาควิชาที่จบ คณะวิศวกรรมศาสตร์ กำแพงแสน</h4>
                        <div class="card">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($deptStudents as $student) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo $student["teacherFirstName"] . " " . $student["teacherLastName"] ?>
                                                </td>
