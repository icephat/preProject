    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <?php include('../layout/dean/report.php'); ?>
                    ...
                    <div>
                        <form class="form-valide" action="../controller/deanSearchFacultyTcas.php" method="post" enctype="multipart/form-data">
                    ...
                    <hr>
                    <h5 style="color:black;">คณะวิศวกรรมศาสตร์ กำแพงแสน รอบที่ <?php echo $round ?> รุ่นที่ <?php echo $gen ?></h5>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body ">
                                    ...
                                    $countStudentSortByDepartments = getCountStudentTcasSortByDepartmentBySemesterYearAndGeneretionAndRound($semesterYear,$gen,$round);
                                    ?>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card shadow mb-4">
                                ...
                                <?php $departmentMMAs = getMaxMinAVGGPAXSortByDepartmentInFacultyBySemesterYearAndGeneretionAndRound($semesterYear,$gen,$round); ?>
                                <div class="card-body ">
                                    <div class="row" style="padding: 20px;">
                                        <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card shadow mb-4">
                                ...
                                <?php
                                $percentageDepartments = getPercentageStudySortByDepartmentInFacultyBySemesterYearAndRoundAndGeneretion($semesterYear,$round,$gen);;
