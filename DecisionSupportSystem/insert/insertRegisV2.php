                ...
                <div class="row">
                    <div class="col-12 mx-auto">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="insert_regis_v2.php" method="post" enctype="multipart/form-data">
                                    <div class="col-sm-6 mb-3  mx-auto">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="text-center">
                                                    <h5 style="color: black;">รุ่นการศึกษา<span
                                            ...
                                            <div class="col-sm-6">
                                                <div class="text-center">
                                                    <input type="number" class="form-control" name="generetion"
                                                        id="generetion" required>
                                                </div>
                                            </div>
                                        </div>
