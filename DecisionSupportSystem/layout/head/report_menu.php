...
<ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown no-arrow">
        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
            ...
            <span class="mr-2 d-none d-lg-inline text-gray-600 small">วรัญญา อรรถเสนา</span>
...
<div class="row">
    ...
    <a href="../../head/home.php" class="col-xl-3 col-md-6 mb-4 " style="text-decoration: none;">
    ...
    <a href="../../head/nisit.php" class="col-xl-3 col-md-6 mb-4" style="text-decoration: none;">
