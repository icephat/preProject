...
if ($departmentId == 0) {
    if ($generetion == 0) {
        ...
        <body OnLoad="document.form1.submit();">
            <form action="../dean/report_student_department_search.php" method="post" name="form1">
        ...
        <body OnLoad="document.form1.submit();">
            <form action="../dean/report_student_department_search_generetion.php" method="post" name="form1">
                <input type="number" name="semesterYear" value="<?php echo $semesterYear; ?>" />
